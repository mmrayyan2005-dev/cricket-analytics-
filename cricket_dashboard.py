...
if section=="🔍 Player Search":
    ...
    if not name:
        st.markdown(f"""
<div style="background:linear-gradient(135deg,#1a1f3a 0%,#0f1117 100%);
            border-radius:20px;padding:36px 28px;margin:8px 0 24px 0;
            border:1px solid #2d3561;text-align:center">
  <div style="font-size:56px;line-height:1;margin-bottom:12px">🏏</div>
  <h1 style="color:#f0f0f0;margin:0 0 6px 0;font-size:28px;font-weight:700">
    Cricket Analytics
  </h1>
  <p style="color:#8899aa;font-size:15px;margin:0 0 20px 0">
    Ball-by-ball records across every major format
  </p>
  <div style="display:flex;justify-content:center;gap:10px;flex-wrap:wrap;margin-bottom:24px">
    <span style="background:#00b894;color:#fff;padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600">ODI</span>
    <span style="background:#0984e3;color:#fff;padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600">Test</span>
    <span style="background:#d63031;color:#fff;padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600">T20I</span>
    <span style="background:#e17055;color:#fff;padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600">IPL</span>
    <span style="background:#6c5ce7;color:#fff;padding:5px 14px;border-radius:20px;font-size:13px;font-weight:600">PSL</span>
  </div>
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;max-width:480px;margin:0 auto 24px auto">
    <div style="background:#1e2130;border-radius:12px;padding:14px 8px;border:1px solid #2a2d3e">
      <div style="font-size:20px">🏏</div>
      <div style="color:#f0f0f0;font-weight:700;font-size:15px;margin-top:4px">Batting</div>
      <div style="color:#888;font-size:12px">Runs · Average · SR</div>
    </div>
    <div style="background:#1e2130;border-radius:12px;padding:14px 8px;border:1px solid #2a2d3e">
      <div style="font-size:20px">🎳</div>
      <div style="color:#f0f0f0;font-weight:700;font-size:15px;margin-top:4px">Bowling</div>
      <div style="color:#888;font-size:12px">Wickets · Econ · SR</div>
    </div>
    <div style="background:#1e2130;border-radius:12px;padding:14px 8px;border:1px solid #2a2d3e">
      <div style="font-size:20px">⚔️</div>
      <div style="color:#f0f0f0;font-weight:700;font-size:15px;margin-top:4px">Matchups</div>
      <div style="color:#888;font-size:12px">Batter vs Bowler</div>
    </div>
  </div>
  <p style="color:#666;font-size:13px;margin:0">
    💡 Try searching: <span style="color:#aaa">Babar · Kohli · Smith · Hazelwood · Rashid · Malinga · Bumrah</span>
  </p>
